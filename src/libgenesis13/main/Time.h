...
inline void Time::setSampleRate(double in) {
    sample=static_cast<int>(round(in));
}
inline void Time::setTimeWindowStart(double in) {
    s0=in;
}
inline void Time::setTimeWindowLength(double in) {
    slen=in;
}


inline double Time::getTimeWindowStart() {
    return s0;
}
inline double Time::getTimeWindowLength() {
    return slen;
}
inline bool Time::isTime() {
    return dotime;
}
inline bool Time::isScan() {
    return doscan;
}
inline int Time::getNodeOffset() {
    return noff_node;
}
inline int Time::getNodeNSlice() {
    return ns_node;
}
inline bool Time::isInitialized() {
    return initialized;
}

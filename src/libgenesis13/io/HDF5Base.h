...
protected:
    ...
    void expandDataset(hid_t fid, vector<double>* rec, int pos, hsize_t recsize,
                       hsize_t slice, char* name);
    ...
    void readDouble1D(hid_t fid, const char* name, double* data, hsize_t dat,
                      hsize_t chunk);

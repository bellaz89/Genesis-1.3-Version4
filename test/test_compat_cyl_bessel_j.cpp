// This unit tests the original implementation of the cylindrical bessel functions
#include <gtest/gtest.h>
#include <cmath>
#include <boost/math/special_functions/bessel.hpp>

#define MAX_ERROR 1e-5 //for MAX_ERROR < 1e-5 the test fails
#define TEST_N_VALUES 100000
#define RANGE 50.0
#define TEST_ORDERS 4
